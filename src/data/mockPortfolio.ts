...
const battleAxeAssets = {
  render: publicAssetUrl('portfolio/battle-axe/battle-axe-marmoset-render.jpg'),
...
const battleAxeMedia = [
  {
    ...
    type: 'image' as const,
    url: battleAxeAssets.render,
    thumbnailUrl: battleAxeAssets.render,
    title: 'Battle Axe Marmoset Render',
    alt: 'Battle Axe Marmoset Render',
    displayLabel: 'Marmoset Render',
    order: 1,
    isCountable: true,
    lightboxEnabled: true,
  },
...
작업 소요시간은 총 2일이며, 최종 렌더와 턴테이블, 텍스처, 작업 과정 이미지를 함께 구성했습니다.`,
    ...
    isFeatured: true,
    thumbnailUrl: battleAxeAssets.render,
    hoverUrl: battleAxeAssets.turntable,
    mediaType: 'image',
    order: 5,
    allOrder: 5.75,
    categoryOrder: 5,
