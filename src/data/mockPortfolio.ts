...
const battleAxeMedia = [
  {
    id: 'battle-axe-detail-01',
    type: 'image' as const,
    url: battleAxeAssets.detail,
    thumbnailUrl: battleAxeAssets.detail,
    title: 'Battle Axe Detail',
    alt: 'Battle Axe Detail',
    displayLabel: 'Detail Render',
    order: 1,
    isCountable: true,
    lightboxEnabled: true,
  },
  {
    id: 'battle-axe-marmoset-render',
    type: 'image' as const,
    url: battleAxeAssets.render01,
    thumbnailUrl: battleAxeAssets.render01Thumb,
    title: 'Battle Axe Marmoset Render',
    alt: 'Battle Axe Marmoset Render',
    displayLabel: 'Marmoset Render 01',
    order: 2,
    isCountable: true,
    lightboxEnabled: true,
  },
  {
    id: 'battle-axe-marmoset-render-02',
    type: 'image' as const,
    url: battleAxeAssets.render02,
    thumbnailUrl: battleAxeAssets.render02Thumb,
    title: 'Battle Axe Marmoset Render 02',
    alt: 'Battle Axe Marmoset Render 02',
    displayLabel: 'Marmoset Render 02',
    order: 3,
    isCountable: true,
    lightboxEnabled: true,
  },
  {
    id: 'battle-axe-turntable',
    type: 'image' as const,
    url: battleAxeAssets.turntable,
    thumbnailUrl: battleAxeAssets.turntable,
    title: 'Battle Axe Turntable',
    alt: 'Battle Axe Turntable',
    displayLabel: 'Turntable',
    order: 4,
    isCountable: true,
    lightboxEnabled: true,
  },
  {
    id: 'battle-axe-texture',
    type: 'image' as const,
    url: battleAxeAssets.texture,
    thumbnailUrl: battleAxeAssets.texture,
    title: 'Battle Axe Texture',
    alt: 'Battle Axe Texture',
  ...
  {
    id: 'battle-axe-work-process',
    type: 'image' as const,
    url: battleAxeAssets.workProcess,
    thumbnailUrl: battleAxeAssets.workProcess,
    title: 'Battle Axe Work Process',
    alt: 'Battle Axe Work Process',
    displayLabel: 'Work Process',
    order: 6,
    isCountable: true,
    lightboxEnabled: true,
...
제작 기간 : 2026.04 ~ 2026.06`,
  ...
  },
  {
    ...
    section: 'personalWorks',
    projectType: 'Props',
    descriptionHtml: `스타일라이즈된 도끼를 주제로 제작한 개인 프롭 작업입니다.
과장된 실루엣과 금속 재질, 장식적인 형태 대비를 살려 판타지 무기의 인상을 명확하게 전달하는 데 집중했습니다.

작업 소요시간은 총 2일이며, 최종 렌더와 턴테이블, 텍스처, 작업 과정 이미지를 함께 구성했습니다.`,
    tools: ['3ds Max', 'ZBrush', 'Substance Painter', 'Marmoset Toolbag'],
    role: 'Full Pipeline',
    year: 2026,
    publishedAt: '2026.07',
    uploadedAt: '2026.07',
    ...
    isFeatured: true,
    thumbnailUrl: battleAxeAssets.detail,
    hoverUrl: battleAxeAssets.render01,
    mediaType: 'image',
    order: 5,
    allOrder: 5.75,
    categoryOrder: 5,
    ...
    chips: [
      { label: 'Props', highlighted: true },
      { label: 'Marmoset', highlighted: false },
    ],
    stats: [
      { key: 'Period', value: '2026.07' },
      { key: 'Production Time', value: '2 Days' },
      { key: 'Renders', value: '6 Images' },
      { key: 'Source', value: 'Local render import' },
    ],
    media: battleAxeMedia,
  },
  {
